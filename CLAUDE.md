...
Everything is in the single file index.html;

- `index.html` - Main HTML structure with input controls and preview area, Core application logic (~470 lines), Styling including print-specific CSS media queries
